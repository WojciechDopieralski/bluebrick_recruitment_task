...
2. We'll check if netto revenue distribution (sum of netto revenue) are identical in both sales. 
...
#Check distribution of revenues in both sales period.
wilcox.test(sum_promo_rev ~ winter_sales, data=only_ws_data)
#Check distribution of rates of revenues in both sales period.
wilcox.test(rev_promo_rate ~ winter_sales, data=only_ws_data)

#Check distribution of revenues in no sales period
